...
export default function Restaurants({ choice }) {
  return (
    <>
      {choice && (
        <div className="grid grid-cols-4 gap-[2vw] mt-[2vw]">
          {[...Array(12)].map(() => {
            return (
              <div className="bg-white border cursor-pointer border-[#DDDDDD] drop-shadow-xl h-[24vw] w-[fit-content] p-[0.5vw] rounded-[1vw]">
