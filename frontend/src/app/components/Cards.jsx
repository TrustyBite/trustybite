            ...
            return (
              ...
              >
                <div className="flex items-center gap-[3vw] my-2">
                  <Image className="w-[6vw]" src={card.src} width={0} height={0} alt={card.title} />
                  <p
                ...
                <div className={`${SatoshiFont.className} text-[1.2vw] font-bold`}>
                  Lorem ipsum dolor sit amet consectetur adipisicing elit.
                  Obcaecati exercitationem ut delectus accusantium voluptates
                  nesciunt molestiae expedita! Fuga, placeat incidunt corrupti
                  hic cupiditate mollitia a magni laborum sed nihil dignissimos?
                </div>
              </motion.div>
            );
          })}
